...
import time
from utils import hash_the_flag, sent_multi_async_requests
from urllib.parse import urlparse
from typing import Final, Any, List, Iterator
...
def save_to_markdown_file(
    ...
    """
    Save string content to a Markdown file.

    Args:
        content: Markdown-formatted string to save
        file_name: file name with proper extension (e.g. 'notes.md')
    ...
    with full_file_path.open("w", encoding=encoding) as f:
        f.write(content)
...
def task_result_verification(task_name:str, answer: str, apikey: str = AI_DEV4_API_KEY,
